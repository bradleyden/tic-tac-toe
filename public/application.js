	...
	var setAPIOrigin = function setAPIOrigin(location, config) {
	  ...
	  if (search.environment === 'development' || location.hostname === 'localhost' && search.environment !== 'production') {
	    if (!(config.apiOrigin = config.apiOrigins.development)) {
	      ...
	      // )
	      config.apiOrigin = 'http://tic-tac-toe.wdibos.com';
	    }
	  } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = api.updateGame;

	var onClick0 = function onClick0() {
	...
	var onNewGame = function onNewGame(event) {
	  ...
	  api.getAllGames().then(ui.loadGamesSuccess).catch(ui.loadGamesFailure);
	  engine.resetGame();
	};

	var onLoadGames = function onLoadGames(event) {
	  event.preventDefault();
	  api.getAllGames().then(ui.loadGamesSuccess).catch(ui.loadGamesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var blankToken = 'https://raw.githubusercontent.com/bradleyden/tic-tac-toe/master/assets/images/blank-token.png';
	var xToken = 'https://raw.githubusercontent.com/bradleyden/tic-tac-toe/master/assets/images/X-token.png';
	var oToken = 'https://raw.githubusercontent.com/bradleyden/tic-tac-toe/master/assets/images/O-token.png';
	...
	var emptySpaces = function emptySpaces(value) {
	  return value === null;
	};

	var isPlayerOne = 0;

	var playerOneCheck = function playerOneCheck() {
	  if (isPlayerOne % 2 === 0) {
	    return true;
	  } else {
	    return false;
	...
	var checkCatsGame = function checkCatsGame() {
	  var fullBoardArray = gameBoard.filter(emptySpaces);
	...
	var fillRow = function fillRow(slot1, slot2, slot3) {
	...
	var placeX = function placeX(space) {
	...
	var placeO = function placeO(space) {
	  if (!gameBoard[space] && !gameOver) {
	    gameBoard[space] = 2;
	...
	var checkRowFull = function checkRowFull() {
	  if (!gameOver) {
	    fillRow(0, 3, 6);
	  }
	  if (!gameOver) {
	...
	module.exports = {
	  ...
	  fillRow: fillRow,
	  checkRowFull: checkRowFull,
	  fullRow: fullRow,
	  placeX: placeX,
	  placeO: placeO,
	  resetGame: resetGame,
	  playerOneCheck: playerOneCheck,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var watchGame = function watchGame(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signOutFailure = function signOutFailure(eror) {};
	...
	var checkWins = function checkWins(gamesArray) {
	  if (gamesArray.cells[0] + gamesArray.cells[3] + gamesArray.cells[6] === 'xxx' || gamesArray.cells[1] + gamesArray.cells[4] + gamesArray.cells[7] === 'xxx' || gamesArray.cells[2] + gamesArray.cells[5] + gamesArray.cells[8] === 'xxx' || gamesArray.cells[0] + gamesArray.cells[1] + gamesArray.cells[2] === 'xxx' || gamesArray.cells[3] + gamesArray.cells[4] + gamesArray.cells[5] === 'xxx' || gamesArray.cells[6] + gamesArray.cells[7] + gamesArray.cells[8] === 'xxx' || gamesArray.cells[0] + gamesArray.cells[4] + gamesArray.cells[8] === 'xxx' || gamesArray.cells[6] + gamesArray.cells[4] + gamesArray.cells[2] === 'xxx') {
	    return true;
	  } else {
	    return false;
	  }
	...
	var checkLosses = function checkLosses(gamesArray) {
	  if (gamesArray.cells[0] + gamesArray.cells[3] + gamesArray.cells[6] === 'ooo' || gamesArray.cells[1] + gamesArray.cells[4] + gamesArray.cells[7] === 'ooo' || gamesArray.cells[2] + gamesArray.cells[5] + gamesArray.cells[8] === 'ooo' || gamesArray.cells[0] + gamesArray.cells[1] + gamesArray.cells[2] === 'ooo' || gamesArray.cells[3] + gamesArray.cells[4] + gamesArray.cells[5] === 'ooo' || gamesArray.cells[6] + gamesArray.cells[7] + gamesArray.cells[8] === 'ooo' || gamesArray.cells[0] + gamesArray.cells[4] + gamesArray.cells[8] === 'ooo' || gamesArray.cells[6] + gamesArray.cells[4] + gamesArray.cells[2] === 'ooo') {
	    return true;
	  } else {
	    return false;
	  }
	...
	var winCount = void 0;
	var lossCount = void 0;

	var loadGamesSuccess = function loadGamesSuccess(data) {
	  var gamesArray = data.games;
	  var winsArray = gamesArray.filter(checkWins);
	  var lossArray = gamesArray.filter(checkLosses);
	...
	module.exports = {
	  ...
	  loadGamesSuccess: loadGamesSuccess,
